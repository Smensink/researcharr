        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "1.0.0",
                    Title = "Researcharr",
                    Description = "Researcharr API docs",
                ...
                c.AddServer(new OpenApiServer
                {
                    ...
                    Variables = new Dictionary<string, OpenApiServerVariable>
                    {
                        ...
                        { "hostpath", new OpenApiServerVariable { Default = "localhost:7337" } }
                    }
                });
            ...
            services.AddAuthorization(options =>
            {
                ...
                // Disable fallback auth policy so UI assets can load without credentials during local testing.
                options.FallbackPolicy = null;
            });

            services.AddAppAuthentication();
            services.AddSingleton<NzbDrone.Core.MetadataSource.OpenAlex.OpenAlexSettings>();
            services.AddSingleton<NzbDrone.Core.MetadataSource.CrossRef.CrossRefSettings>();
        }
