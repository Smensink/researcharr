...
namespace NzbDrone.Core.Download.Clients.Nzbget
{
    ...
    public class NzbgetSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "Recent Priority", Type = FieldType.Select, SelectOptions = typeof(NzbgetPriority), HelpText = "Priority to use when grabbing papers published within the last 14 days")]
        public int RecentTvPriority { get; set; }

        [FieldDefinition(8, Label = "Older Priority", Type = FieldType.Select, SelectOptions = typeof(NzbgetPriority), HelpText = "Priority to use when grabbing papers published over 14 days ago")]
