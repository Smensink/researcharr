...
namespace NzbDrone.Core.ImportLists
{
    public class ImportListSyncService : IExecute<ImportListSyncCommand>
    {
        ...
        {
            // Simplified mapping logic since Goodreads is gone
            // In a real implementation, we'd map using OpenAlex or another provider
            // For now, we just rely on existing IDs if present
        ...
        {
            // Simplified mapping logic since Goodreads is gone
            // We'd need to use OpenAlex search here in future
            _logger.Trace($"Skipping author mapping for {report.Author} as Goodreads is removed");
        }
