...
namespace NzbDrone.Core.Notifications
{
          ...
          IHandle<UpdateInstalledEvent>
    {
        ...
        {
            return string.Format("Researcharr failed to Import all files for {0}",
                source);
        }
        ...
        public void Handle(UpdateInstalledEvent message)
        {
            ...
            updateMessage.Message = $"Researcharr updated from {message.PreviousVerison.ToString()} to {message.NewVersion.ToString()}";
