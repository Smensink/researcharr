...
namespace NzbDrone.Core.Notifications.Subsonic
{
    public class Subsonic : NotificationBase<SubsonicSettings>
    {
        ...
        {
            const string header = "Researcharr - Grabbed";
        ...
        {
            const string header = "Researcharr - Downloaded";
        ...
        {
            const string header = "Researcharr - Author Deleted";
        ...
        {
            const string header = "Researcharr - Book Deleted";
        ...
        {
            const string header = "Researcharr - Book File Deleted";
