...
module.exports = {
  ...
  themeRed: readarrRed,
  themeAlternateRed: '#0a2f52',
  themeDarkRed: '#082540',
  themeDarkColor: '#353f54',
  themeLightColor: '#144f7a',
  ...
  linkColor: '#fff',
  linkHoverColor: readarrRed,

  // Header
  pageHeaderBackgroundColor: '#0a2f52',
  ...
  // Toolbar
  toolbarColor: '#e1e2e3',
  toolbarBackgroundColor: '#0b2f4a',
  toolbarMenuItemBackgroundColor: '#0d3b66',
  toolbarMenuItemHoverBackgroundColor: '#0a2f52',
