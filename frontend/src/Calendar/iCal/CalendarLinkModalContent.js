...
function getUrls(state) {
  ...
  let icalUrl = `${window.location.host}${window.Researcharr.urlBase}/feed/v1/calendar/Readarr.ics?`;
  ...
  icalUrl += `pastDays=${pastDays}&futureDays=${futureDays}&apikey=${encodeURIComponent(window.Researcharr.apiKey)}`;
