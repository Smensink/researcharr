    ...
    return (
      <PageContent title={translate('GeneralSettings')}>
        ...
        <ConfirmModal
          ...
          message={
            `Researcharr requires a restart to apply changes, do you want to restart now? ${isWindowsService ? 'Depending which user is running the Researcharr service you may need to restart Researcharr as admin once before the service will start automatically.' : ''}`
          }
